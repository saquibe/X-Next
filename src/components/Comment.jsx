...
export default function Comment({ comment, id, commentId, originalPostId }) {
  ...
  return (
    <div className="flex p-3 border-b border-gray-200 hover:bg-gray-50 pl-10">
      ...
      <div className="flex-1">
        ...
        <HiHeart
          onClick={likePost} 
          className="h-8 w-8  cursor-pointer rounded-full transition text-red-500 duration-500 ease-in-out p-2 hover:text-red-500 hover:bg-red-100"/>
      ) : (
        <HiOutlineHeart
          onClick={likePost} 
